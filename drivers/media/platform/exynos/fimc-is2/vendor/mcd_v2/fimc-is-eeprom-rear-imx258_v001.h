...
/* Reference File
 * Universal EEPROM map data V001_20180703_for A7_2018_Lassen_DW9808_10K_EEPROM_(IMX576_24M).xlsx
 */

#define FIMC_IS_REAR_MAX_CAL_SIZE (10 * 1024)

const struct fimc_is_vender_rom_addr rear_imx258_cal_addr = {
	/* Set '-1' if not used */
	...
	0xA8,				//int32_t		rom_header_module_id_addr;
	...
	(0x1CEF-0x0300+1),	//int32_t		rom_shading_checksum_len; (6639)
	...
	(0x1F5F-0x1F00+1),	//int32_t		rom_dual_checksum_len; (96)
